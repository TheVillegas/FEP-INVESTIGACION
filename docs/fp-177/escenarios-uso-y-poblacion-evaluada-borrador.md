...
> **Estado:** Decisiones de alcance y método confirmadas por consenso del equipo; documento estructurado con asistencia de IA. No asigna puntajes ni recomienda proveedores.
>
> **Contexto seleccionado:** GENERAL (no específico de ONEBYTE). Este documento operacionaliza el alcance confirmado del equipo. La metodología y matriz comunes se documentan en `metodologia-comparativa-borrador.md` y `matriz-criterios-y-ponderaciones-borrador.md`.
...
4. **Herramientas de estimación temprana/políticas:** Infracost y Cloud Custodian.
5. **FOCUS** se trata como un **estándar transversal**, no como producto de proveedor.

**Clasificación confirmada:** `Cloud Custodian` pertenece a “estimación temprana/políticas” por su función de *policy-as-code* para gobierno y control preventivo. Esta clasificación define su elegibilidad en el escenario E4; no demuestra por sí sola capacidad de estimación ni sustituye la evidencia requerida para cada indicador.
...
## 4. Escenarios comparables acordados
...
- La inclusión de una alternativa en la matriz no valida externamente sus capacidades: se requiere evidencia admisible por indicador y escenario.

## 7. Aplicación acordada

El consenso del equipo confirma categorías, productos, escenarios, fuentes, período y reglas de normalización como marco de aplicación. Antes de puntuar un producto, se deben registrar la evidencia, versión, configuración y fecha de corte exigidas por la metodología.

**Estado final de este artefacto:** **Alcance y método confirmados por consenso del equipo; documento estructurado con asistencia de IA.**
