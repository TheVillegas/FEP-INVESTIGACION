...
app151810098
                                         these limitations, lightweight virtualization technologies such as containers have gained
...
This article is an open access article
                                         placement through filtering and scoring. In this process, the resource request configuration
...
5.    Li, D.; Wei, Y.; Zeng, B. A Dynamic I/O Sensing Scheduling Scheme in Kubernetes. In Proceedings of the 4th International
      ...
      pp. 14–19. [CrossRef]
6.    Dakić, V.; Ðambić, G.; Slovinac, J.; Redžepagić, J. Optimizing Kubernetes Scheduling for Web Applications Using Machine
