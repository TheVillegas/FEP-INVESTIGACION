...
Published: 29 March 2026
                                         As a result, many cloud-operational tasks are naturally framed as online, multi-objective
...
distributed under the terms and
                                         mechanism [2]. Cloud providers offer a rich menu of VM specifications, and operators
          ...
          This work                                                       Explicit                            (interpretable
                             ...
                             rolling, incremental)
                              ...
                              Time is discretized into T decision windows indexed by t ∈ {1, . . . , T }, each of fixed
                                                                                                     1
                              duration h hours. For example, a 5-min window corresponds to h = 12      . VMs are indexed
                              ...
                              window. We consider two resource dimensions, CPU and memory. Let ℛ         R≔{cpu, mem}
                              and index resources by r ∈ R. For readability, Table 2 summarizes the main notation used
...
Appl. Sci. 2026, 16, 3302                                                                                                      8 of 48
                            ...
                            that window is
                                  ...
                                  Let xi,t ∈ K denote the VM type assigned to VM i in window t, and let
                            ℛxt ≔( x1,t , . . . , x N,t ) denote the assignment vector at time t. The total platform cost in window
                             t is
                                                                                N
                                                                  Costt (xℛt )≔ ∑ cost( xi,t ).
                                                                               i =1

                                 This explicit cost model is required because the budget constraints in Section 3.7 apply
...
Appl. Sci. 2026, 16, 3302                                                                                                      9 of 48
       ...
       Base budget policy                 B0 calibrated once; held fixed
                                                                                          workload; fixed across runs/seeds
     ...
     Dual update step size                             η = 1.0
                                                                                                     (Section 6.1.2)
  Risk amplification weights                     β 1 = 0.3; β 2 = 0.4                           Fixed across all scenarios
         Overload–waste
       ...
       Dual upper bound                              νmax = 109                                 Fixed across experiments
                               ...
                               •                   ℛ ≔ L1 ∑lL=1 di,t,r (l )
                                    Mean demand: µi,t,r
                                                                                          
                                                                                       L
                               •                          ℛ ≔Quantile0.95 {di,t,r (l )}l =1 .
                                    Tail demand (p95): qi,t,r
                                                                            q
                                                                                                            2
                               •                                       ℛ ≔ L1 ∑lL=1 (di,t,r (l ) − µi,t,r )
                                    Volatility (standard deviation): σi,t,r
                               •    Irregularity (entropy): For each VM i, window t, and resource r, we define the raw
                                    Shannon entropy as
                                                                              Bbin
                                                                      ℛ ≔ − ∑ pi,t,r (b) log2 pi,t,r (b)
                                                                    raw
                                                                   Hi,t,r
                                                                              b =1
...
Appl. Sci. 2026, 16, 3302                                                                                                       10 of 48
                                 ...
                                 fixed absolute range [0, capmax
                                                             r   ]. The probabilities pi,t,r (b) are obtained by histogram-
                                 ...
                                 The fixed absolute range [0, capmax r  ] and the normalization by log2 Bbin make entropy
                            ...
                            3.4. Decision Variables and Resizing Stability
                                 ...
                                 For notational convenience, we define capr ( xi,t  ℛ)≔capr (k) where k = xi,t .
                            ...
                            change indicator
                                                       chgℛi,t ≔I{ xi,t ̸= xi,t−1 }, ∀i, ∀t ≥ 2

                            where I{·} denotes the indicator function (and we set chgℛi,1 ≔0 by convention).
                                 Optionally, a minimum dwell-time constraint can be imposed to prevent rapid oscilla-
                            ...
                            resource dimension. We use the positive-part operator [ aℛ       ]+ ≔max{0, a}.
                                 Throughout Sections 3.5 and 3.6, the statistics µi,t,r , qi,t,r , σi,t,r and Hi,t,r denote the most
...
Appl. Sci. 2026, 16, 3302                                                                                                         11 of 48
                            ...
                            more severe under highly volatile or irregular workloads.
                                  For each VM i, window t, and resource r, we define the raw tail shortfall as
                                                            ...
                                                            δi,t,r (xℛt )≔[qi,t,r − capr ( xi,t )]+

                            where qi,t,r is the 95th-percentile demand and capr ( xi,t ) is the allocated capacity. To mod-
                            ulate overload severity under volatile or irregular workloads, we introduce a workload-
                            dependent weighting factor
                                                                   ℛ ≔ω (σi,t,r , Hi,t,r )
                                                                 ωi,t,r

                            where σi,t,r and Hi,t,r denote the standard deviation and entropy of demand samples within
                            ...
                            risk amplification.
                                 The risk-weighted overload term is then defined as
                                                             ...
                                                             overi,t,r (xℛt )≔ωi,t,r · δi,t,r (xt )

                                 This construction penalizes assignments that provide insufficient headroom during
                            ...
                            resource r ∈ R, we define the waste amount as
                                                         ...
                                                         wastei,t,r (xℛt )≔[capr ( xi,t ) − µi,t,r ]+ .

                            where µi,t,r is the mean demand within window t. This term quantifies unused capacity rel-
...
Appl. Sci. 2026, 16, 3302                                                                                                        12 of 48
                            ...
                            scale capmax
                                      r   so that CPU and memory contribute as dimensionless ratios. Because this is a
                            ...
                            as follows:
                                  ...
                                  The first objective f 1 captures overall sizing quality by aggregating, over time, the
                            ...
                            mandatory and performance–efficiency trade-offs are optimized under that constraint.
                                  The second objective f 2 captures operational stability by penalizing frequent resizing
                            actions. The indicator chgi,t , introduced in Section 3.4, equals one when VM i changes its
                            assigned type between consecutive windows and zero otherwise. By minimizing f 2 , the
...
Appl. Sci. 2026, 16, 3302                                                                                                    13 of 48
                            ...
                            lently write
                                                    gt (x1:tℛ)|≔| gt (Cost1 (x1 ), . . . , Costt (xt ))

                            since the realized cost sequence up to time t is uniquely determined by x1:t . Different oper-
...
Appl. Sci. 2026, 16, 3302                                                                                              14 of 48
                            ...
                            or equivalently,
                                                                 t
                                                    gtabs_cum = ∑ Costτ (xτ ) − Babs_cum (t) ≤ 0.
                                                                τ =1
                            ...
                            which can be written as
                                                  ...
                                                  inc
                                                  t ≔Costt (xt ) − Costt−1 (xt−1 ) − Binc_cum ( t ) ≤ 0
                                                 gℛ

                            with g1inc = 0 by convention. For t = 1, we treat x1 as given; alternatively, a run-rate cap
                            ...
                            plements the resizing-stability objective f 2 , which penalizes the frequency of configuration
...
Appl. Sci. 2026, 16, 3302                                                                                                        15 of 48
                                 ...
                                 We use this affine form as the budget residual gtinc in the BD solver to preserve the
                            ...
                            a VM type assignment vector xt = ( x1,t , . . . , x N,t ) ∈ K N , where xi,t denotes the VM type
                            assigned to VM i during window t. Let x1:T     ℛ ≔(x1 , . . . , xT ) denote the full resizing plan.
                            Budget feasibility is enforced through the constraint family
                            ...
                            bi-objective optimization:
                                                            min ( f 1 (x1:T ), | f 2 (x1:T ))               (7)
                                                                  x1:T ∈F

                            where f 1 aggregates, over time, the trade-off between resource waste and risk-weighted
                            overload, and f 2 penalizes resizing frequency to capture operational stability. A feasi-
                                          ∗ ∈ F is Pareto optimal if no other feasible sequence weakly improves
                            ble solution x1:T
...
Appl. Sci. 2026, 16, 3302                                                                                                   16 of 48
                            ...
                            scalarized variant of BC-V MR, denoted by BC-V MRρ for ρ ≥ 0:

                                                  min Fρ (x1:T ),   Fρ (x1:T ) = f 1 (x1:T ) + ρ f 2 (x1:T )                    (8)
                                                 x1:T ∈F
                            ...
                            3.8.3. Stage-Wise Structure and Per-Window Interpretation
                                 The scalarized objective admits an additive stage-wise representation:
                                                   ...
                                                   T                                        T    N
                                               ℛ)≔ ∑ (Wastet (xt ) + λ Overt (xt )) + ρ ∑ ∑ I{ xi,t ̸= xi,t−1 },
                                        Fρ (x1:T                                                                                (9)
                                                  t =1                                    t =2 i =1
...
Appl. Sci. 2026, 16, 3302                                                                                                   17 of 48
                            ...
                            Define the spacing constant ℛ    M≔1 + ∑iN=1 vi + max vi , qi = µi = i · M. If the overload
                                                                                  i
                            amplification factor in Section 3.5.1 satisfies ω (·) ≥ 1, we fix all VMs to share a constant
                            ...
                            budget is set to ℛ   B′ ≔ Nc0 + C.
                                  Assigning type bi yields zero waste and zero tail shortfall, whereas assigning type
                            ai yields a tail shortfall of exactly vi with zero waste. Any mismatch assignment using a
                            type intended for a different index j ̸= i incurs a penalty exceeding ∑k vk . Specifically, if
                            ...
                            reduces to
                                                        ∑ cost(ai ) + ∑ pi zi ≤ B′ ⇐⇒ ∑ pi zi ≤ C,
                                                      i              i                  i

                            and the objective satisfies

                                                   Fρ = ∑ vi (1 − zi ) ≤ ∑ vi − V ⇐⇒ ∑ vi zi ≥ V.
                                                          i                i                i
...
Appl. Sci. 2026, 16, 3302                                                                                             19 of 48
                            ...
                            dimensions, revealing a per-VM separable structure inside f 1 .
                            ...
                            Because VM types are discrete, it is possible that, in some windows, no assignment xt ∈ K N
...
Appl. Sci. 2026, 16, 3302                                                                                                       20 of 48
                            ...
                            surrogate cost function:
                                                                            ...
                                                                            T
                                                    min Fρ (x1:T ) | + | ∑ νt gt (x1:t ),        νt ≥ 0 ∀t.                        (10)
                                                     x1:T
                                                                          t =1
                            ...
                            tive/rolling carry-over terms). Hence, in the primal step with fixed νt ,
                                                            ...
                                                            νt gt | = | νt at Costt (xt ) | + | νt ct ,

                            and the term νt ct is constant with respect to xt and can be dropped from the minimization.
                            Finally, since Costt (xt ) = ∑iN=1 cost( xi,t ), the surrogate objective decomposes across VMs,
...
Appl. Sci. 2026, 16, 3302                                                                                                                  21 of 48
                                  ...
                                  any minimizer xt (ν), a valid dual subgradient is given by the realized budget residual
                                   rate_pw
                                  gt       (xt ). Consequently, the update used in Algorithm 1,
                                                                                              ∼
                                                                                                    
                       ...
                       xi,t ∈ argmin
                                k ∈K r ∈R
                                           ∑ wr (wastei,t,r (k) + λ overi,t,r (k))| + |ρ I{k ̸= xi,t−1 }| + |νt cost(k) ,                     (11)
...
Appl. Sci. 2026, 16, 3302                                                                                                22 of 48
                            ...
                            into a simple additive bias toward cheaper instance types while preserving the existing f 1
                            − f 2 trade-off encoded by the first two terms.
...
Appl. Sci. 2026, 16, 3302                                                                                                     23 of 48
                            ...
                            bound for projected subgradient methods over the compact domain      νmax ] applies, which
                                                                                             [0,
                                                                               √ yields an O √1
                            establishes the claimed inequality. Choosing η = νmax                   dual regret rate. The
                                                                              G T                T
                            same primal–dual
                                              argument implies  that the time-average violation magnitude  also decays
...
Appl. Sci. 2026, 16, 3302                                                                                                     24 of 48
                            ...
                            resource-demand samples di,t,r (l ) (measured in vCPU for r = cpu and GiB for r = mem).
                                 Given an assigned type xi,t , the corresponding utilization
                                                                                              ratiois computed only
                                                                                                 di,t,r (l )
                            for reporting and monitoring purposes as ui,t,r (l ) = min                        , 1   , r ∈ {cpu, mem}.
                                                                                                capr ( xi,t )
...
Appl. Sci. 2026, 16, 3302                                                                                             25 of 48
                            ...
                            rather than as an arbitrary convenience. It preserves a direct interpretation of β 1 and β 2 as
                            ...
                            The coefficient β 1 controls sensitivity to workload volatility (intra-window variability),
                            while β 2 controls sensitivity to workload irregularity captured by entropy. In all experi-
                            ments, we fix β 1 = 0.3 and β 2 = 0.4 to give slightly more weight to irregularity than to
...
Appl. Sci. 2026, 16, 3302                                                                                            26 of 48
                            ...
                            window cost observed under the Static policy in the calibration run.
                                                                        
                                                      ℛ ≔maxCostt xstatic , Brate_pw = α · B0rate .
                                                   B0rate
                                                            t
...
Appl. Sci. 2026, 16, 3302                                                                                                       27 of 48
                            ...
                            released according to a predefined trajectory.
                                                        ...
                                                        T              T
                                                    ℛ ≔ ∑ Costt xstatic , ∑ Costt (xt ) ≤ α · B0cum .
                                                 B0cum
                                                         t =1                    t =1

                                 For the incremental budget, we use a time-invariant per-window increment cap over
                            the horizon Binc_cum (ℛt)≔α · B0inc for all t ≥ 2. Because the Static policy keeps configura-
                            tions fixed and would yield a degenerate zero increment under direct calibration, we set
                            B0ℛ  ≔ 0
                              inc Brate (the calibrated peak per-window spend) as a common reference scale. With this

                            choice, the multiplier α directly controls the allowed relative growth per window under the
                            ...
                            models and budget magnitudes. For the incremental budget, we reuse B = B0rate = B0inc
                            for normalization.
...
Appl. Sci. 2026, 16, 3302                                                                                               30 of 48
                            ...
                            monotonically, consistent with the shadow-price monotonicity intuition ( ∂B ∂ν
                                                                                                           ≤ 0).
...
Appl. Sci. 2026, 16, 3302                                                                                                   34 of 48
                            ...
                            in Section 5.3, and let
                                                                                          ...
                                                                                          N
                                               ℓt (xℛt )≔Wastet (xt ) + λOvert (xt ) + ρ ∑ I{ xi,t ̸= xi,t−1 }
                                                                                         i =1

                            denote the corresponding per-window primal objective in Equation (9). We approximate
                            the dual lower bound d∗t = max0≤ν≤νmax dt (ν) via a simple 1D grid search over ν (log-
...
Appl. Sci. 2026, 16, 3302                                                                                              40 of 48
                            ...
                            and the amplification weights ( β 1 , β 2 ) around the default setting. Across these variants,
...
Appl. Sci. 2026, 16, 3302                                                                                                     41 of 48
                            ...
                            balances the sizing-quality objective f 1 and the stability objective f 2 across qualitatively
                            ...
                            VM and (b) per-VM f 1 (waste plus overload penalty) for Static, Greedy, BD with ρ ∈ {0.5, 2, 5, 10},
                            and NSGA-II. Lower f 1 indicates better sizing quality.
...
Appl. Sci. 2026, 16, 3302                                                                                            43 of 48
                                  ...
                                  Figure 9b reports the per-VM value of f 1 (waste plus overload penalty), which reflects
                            how well the policy aligns capacity to sustained demand. Greedy attains the lowest
                            f 1 (3.41), but only by aggressive reconfiguration. BD at ρ = 0.5 achieves a competitive
                            f 1 (4.59) while drastically reducing churn, whereas BD at ρ = 2 returns close to Static
                            behavior ( f 1 = 11.29 vs. 11.73 for Static). NSGA-II provides an offline reference with
                            f 1 = 5.32 and 7.90 migrations per VM, showing that higher-quality solutions are possible
...
Appl. Sci. 2026, 16, 3302                                                                                                      46 of 48
                            ...
                            constraints: the objective function f 1 , capturing the waste–overload trade-off, and the
                            stability-oriented objective function f 2 , penalizing reconfiguration frequency. While the
