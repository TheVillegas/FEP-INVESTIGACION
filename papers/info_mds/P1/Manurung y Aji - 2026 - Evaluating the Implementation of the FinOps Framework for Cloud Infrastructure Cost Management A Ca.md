...
> **Evidencia de clasificación:** Fila académica del CSV titulada “Evaluating the Implementation of the FinOps Framework for Cloud Infrastructure Cost Management: A Case Study of Technology Companies in Indonesia”, código P1.
> **Archivo fuente:** papers-pdf/Manurung y Aji - 2026 - Evaluating the Implementation of the FinOps Framework for Cloud Infrastructure Cost Management A Ca.pdf
...
- **Autores verificados en el PDF:** Hierony Manurung y Rizal Fathoni Aji.
- **Fecha bibliográfica utilizada:** 2025. El encabezado identifica *Scientific Journal of Informatics*, vol. 12, n.º 4, noviembre de 2025, y el artículo ocupa las pp. 709–720.
- **Discrepancia documentada:** el nombre del archivo contiene 2026, mientras que el propio PDF y la matriz registran la publicación en 2025. Para la referencia bibliográfica se usa **2025**, por ser el año de publicación visible en el documento.

## 3. Problema que trata

El trabajo estudia la distancia entre la adopción de herramientas de optimización cloud y la madurez organizacional necesaria para practicar FinOps de forma integral. En empresas tecnológicas de Indonesia, la presión por rentabilidad convive con procesos de presupuesto, asignación, gobernanza y responsabilidad financiera que permanecen centralizados, reactivos o informales. Los autores denominan a esta diferencia **disonancia técnico-cultural**.

## 4. Qué quiere hacer

- Evaluar la madurez de adopción de FinOps en varias empresas tecnológicas de Indonesia.
- Contrastar las prácticas reales con las capacidades y fases del FinOps Framework.
- Identificar brechas entre optimización técnica, gobernanza, asignación de costos, cultura y colaboración.
- Proponer una línea de avance desde los niveles *Crawl* y *Walk* hacia *Run*.

## 5. Cómo lo hace

Emplea un estudio de casos con métodos mixtos y diseño explicativo secuencial. Primero realiza entrevistas semiestructuradas a seis arquitectos de infraestructura cloud seleccionados por muestreo intencional; luego aplica análisis temático. Los hallazgos cualitativos se mapean a siete áreas de capacidad y a una escala de tres puntos —Crawl, Walk y Run— para obtener una puntuación de madurez por participante (sección **Methods**, tablas 1–5).

## 6. Resultados

- El promedio del grupo fue **1,53 de 3,00**, entre Crawl y Walk; solo el participante P2 alcanzó 2,00 (sección **FinOps maturity score**, tabla 5, p. 715 del artículo).
- El 100 % de los participantes mostró propiedad de costos centralizada y ausencia de showback/chargeback; también el 100 % carecía de un proceso formal para vincular costo cloud con valor de negocio y de responsabilidad compartida entre funciones (tabla 4, pp. 714–715).
- Se observaron capacidades técnicas más desarrolladas: 67 % usaba reservas, Savings Plans o Spot, y 83 % aplicaba acciones como rightsizing o encendido/apagado (tabla 4).
- Persistieron brechas en presupuesto/pronóstico, herramientas y educación FinOps (83 % en cada caso), y en políticas formales de gobernanza (67 %).
- **Interpretación de los autores:** la adopción ocurre a dos velocidades; las herramientas y optimizaciones preceden a la responsabilidad financiera distribuida.

## 7. Discusión y trabajo futuro

Los autores sostienen que avanzar requiere showback granular, propiedad distribuida, etiquetado y políticas formalizadas, automatización de controles y métricas de economía unitaria. Reconocen que seis participantes no permiten generalización estadística nacional; plantean generalización analítica por consistencia temática. Proponen encuestas cuantitativas estratificadas de mayor escala y estudios longitudinales que observen cómo evoluciona la madurez bajo presión económica (secciones **Limitations and generalizability** y **Recommendations for future research**, pp. 717–718).

## 8. Conclusión del paper

Los autores concluyen que las organizaciones examinadas se encuentran principalmente en Crawl: dominan acciones técnicas de optimización, pero mantienen gobernanza centralizada y presupuestos reactivos. Presentan la disonancia técnico-cultural como aporte para comprender mercados emergentes y consideran útil el modelo Crawl/Walk/Run como instrumento diagnóstico. Aclaran que el valor 1,53 es indicativo y que debe comprobarse con muestras mayores.

## Relación preliminar con INV-01

La fuente puede apoyar la lectura de los apartados 2.5–2.6 y 3.1–3.5 de INV-01: fases FinOps, roles, asignación, showback/chargeback, economía unitaria y responsabilidad compartida. También documenta por qué la optimización técnica aislada no equivale a una práctica FinOps madura. Esta relación es solo de orientación documental y no sustituye el análisis crítico ni el aporte propio del grupo.

## Limitaciones de esta síntesis

Síntesis generada para lectura personal a partir del PDF local. La investigación usa una muestra intencional de seis participantes y autoinforme; sus porcentajes describen ese grupo, no toda Indonesia. La fecha del archivo no coincide con la publicación. Toda afirmación, cifra y referencia debe validarse humanamente contra el texto y sus tablas antes de incorporarse al informe.

## Texto extraído del PDF

> **Advertencia de conversión:** extracción textual automática de 12 páginas (53763 caracteres). Se conservaron títulos, párrafos, referencias y contenido textual por página. La disposición multicolumna, las figuras, las tablas y las ecuaciones pueden no mantener su alineación o representación visual; verifique esos elementos en el PDF original.
...
Theme          Supporting Words                         Quote from Participants
    ...
    Strategies            reserved    instances,
                             ...
                             start/stop        non-
                        production               "Low-hanging  fruit  like  turning  off  unused VMs  or  scaling down
...
The participant's score for each domain is described in Table 5.
    ...
    Particip         (1)                                                   (5)              (6)                      Score
      ...
      ant      Allocation                                 Awareness   Governance                (Average
                                 ting      izing       on
                                                                                                                                                    )
