...
**Beneficios.** La visibilidad de costo cercana al uso permite evaluar alternativas antes del despliegue, relacionar eficiencia con arquitectura y actuar sobre desperdicio o anomalías sin separar el costo de las demás señales operativas [2].
...
**Beneficios.** La categorización consistente mejora la identificación de gasto no asignado, el showback o chargeback y la calidad de presupuestos y previsiones, facilitando comparaciones entre inversión tecnológica y valor esperado [3].
...
**Beneficios.** La visibilidad temprana del costo permite decisiones de continuar, ajustar o detener, relaciona funcionalidades con resultados de negocio y ayuda a anticipar cuánto pesa la infraestructura en el precio o margen [5].
...
**Beneficios.** La conexión entre inversión tecnológica y objetivos de negocio mejora la previsibilidad, la responsabilidad y la evaluación de riesgos financieros, contractuales y técnicos [7].
...
Las *Allied Personas* son disciplinas tradicionales o emergentes cuya actividad se cruza con FinOps y que coordinan con sus profesionales cuando sus datos, controles o decisiones resultan pertinentes [1]. Como categorías del framework, tampoco implican asignaciones concretas para el equipo del curso.

### ITAM (IT Asset Management teams) [1]

ITAM se enfoca en descubrir, inventariar, auditar y administrar activos y licencias tecnológicos. Aporta datos de propiedad, uso, contratos y cumplimiento que mejoran la visibilidad del gasto y permiten detectar ineficiencias. Colabora con FinOps, Finanzas y Adquisiciones para equilibrar costo, riesgo contractual y valor en decisiones sobre activos.

**Responsabilidades dentro del ciclo FinOps:**

- Proporcionar inventarios conciliados y datos de licencias para asignar y explicar costos.
- Evaluar subutilización, duplicidades y alternativas de renovación o reasignación.
- Ejecutar y controlar bajas, recuperaciones o ajustes de licencias acordados.

### ITFM (IT Financial Management) [1]

ITFM se enfoca en registrar, categorizar, presupuestar y reportar el gasto tecnológico cuando opera como disciplina diferenciada de Finanzas. Aporta contabilidad de costos, previsiones y análisis de inversión que conectan el consumo con prioridades y valor medible. Colabora con FinOps para mejorar la transparencia financiera, priorizar inversiones y sostener procesos de mejora continua.

**Responsabilidades dentro del ciclo FinOps:**

- Suministrar presupuestos, previsiones y categorías financieras comparables con el consumo.
- Analizar variaciones y escenarios para priorizar oportunidades de eficiencia e inversión.
- Incorporar decisiones aprobadas en reportes, presupuestos y controles financieros.

### Sostenibilidad [1]

Sustainability se enfoca en comprender y reducir el impacto ambiental asociado al uso tecnológico. Aporta métricas, políticas y análisis de eficiencia que hacen visibles los efectos ambientales y el avance hacia objetivos organizacionales. Colabora con FinOps para valorar conjuntamente desperdicio, costo, desempeño e impacto ambiental al seleccionar acciones de optimización.

**Responsabilidades dentro del ciclo FinOps:**

- Proporcionar indicadores de impacto ambiental y eficiencia vinculados con el consumo.
- Evaluar oportunidades considerando ahorro, desempeño y objetivos de sostenibilidad.
- Verificar la ejecución y el resultado ambiental de las acciones priorizadas.

### ITSM (IT Service Management) [1]

ITSM / ITIL se enfoca en estandarizar y mejorar la gestión de servicios tecnológicos, su calidad y su confiabilidad. Aporta catálogos, niveles de servicio, datos operativos y registros de cambios que contextualizan el costo de prestar cada servicio. Colabora con FinOps para equilibrar prioridades de costo con desempeño y continuidad, integrando las acciones acordadas en los procesos de operación y cambio.

**Responsabilidades dentro del ciclo FinOps:**

- Facilitar datos de servicios, niveles acordados, desempeño e historial de cambios.
- Evaluar optimizaciones frente a riesgos de disponibilidad, calidad y continuidad.
- Gestionar cambios aprobados y controlar sus efectos sobre costo y nivel de servicio.

### Seguridad [1]

Security se enfoca en proteger los entornos tecnológicos mediante controles, cumplimiento, gestión de identidades y respuesta ante anomalías. Aporta hallazgos, políticas, señales de uso y datos del gasto en seguridad para interpretar costos y riesgos. Colabora con FinOps para optimizar la inversión en controles sin debilitar la postura de seguridad ni trasladar decisiones de riesgo fuera de la autoridad correspondiente.

**Responsabilidades dentro del ciclo FinOps:**

- Proporcionar visibilidad del uso, costo y cobertura de controles de seguridad.
- Evaluar oportunidades de ahorro según exposición, cumplimiento y riesgo residual.
- Implementar o gobernar ajustes aprobados y vigilar anomalías posteriores.

## Referencias

[1] FinOps Foundation. *FinOps Personas*. https://www.finops.org/framework/personas/

[2] FinOps Foundation. *Engineering*. https://www.finops.org/framework/persona/engineering/

[3] FinOps Foundation. *Finance*. https://www.finops.org/framework/persona/finance/

[4] FinOps Foundation. *Procurement*. https://www.finops.org/framework/persona/procurement/

[5] FinOps Foundation. *Product*. https://www.finops.org/framework/persona/product/

[6] FinOps Foundation. *FinOps Practitioner*. https://www.finops.org/framework/persona/finops-practitioner/

[7] FinOps Foundation. *Leadership*. https://www.finops.org/framework/persona/leadership/
