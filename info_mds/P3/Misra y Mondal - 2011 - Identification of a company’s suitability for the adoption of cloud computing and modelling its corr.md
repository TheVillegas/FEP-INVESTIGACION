...
> **Evidencia de clasificación:** Fila académica del CSV titulada “Identification of a company's suitability for the adoption of cloud computing and modelling its corresponding Return on Investment”, código P3.
> **Archivo fuente:** papers-pdf/Misra y Mondal - 2011 - Identification of a company’s suitability for the adoption of cloud computing and modelling its corr.pdf
...
- **Autores verificados en el PDF:** Subhas Chandra Misra y Arka Mondal.
- **Fecha bibliográfica utilizada:** 2011, *Mathematical and Computer Modelling*, 53, pp. 504–521. El copyright y la aceptación son de 2010, pero la edición es 2011.

## 3. Problema que trata

Las empresas podían adoptar cloud por expectativas de ahorro sin evaluar si su tamaño, uso, sensibilidad de datos y criticidad hacían conveniente la migración. Los modelos de ROI disponibles se concentraban en costos directos y casos específicos, dejando fuera beneficios intangibles y alternativas como migración parcial.

## 4. Qué quiere hacer

Proporcionar dos herramientas: un índice previo que indique la idoneidad de una empresa para cloud y un modelo general de ROI que integre costo, ahorro e impactos intangibles.

## 5. Cómo lo hace

Construye una tabla ponderada de factores empresariales —tamaño de recursos, patrón de utilización, sensibilidad de datos y criticidad— y deriva umbrales para un índice de idoneidad. Luego amplía el ROI tradicional con costos cloud/TCO y valoraciones propuestas para flexibilidad, escalabilidad, time-to-market, satisfacción, tiempo de provisión, foco en competencias, recuperación ante desastres y Green IT. Ilustra una migración parcial donde la nube cubre demanda sobre una capacidad interna (secciones 3–4).

## 6. Resultados

- Con las ponderaciones del artículo, un índice inferior a **3.760** desaconseja adopción, entre **3.760 y 4.600** exige más análisis y sobre **4.600** indica alta conveniencia (sección 3, **Interpretation of results**, p. 513). Los umbrales cambian si se cambian ponderaciones.
- El ROI cloud propuesto es `(aumento de beneficio + reducción de costo − costos cloud) / costos cloud` (ecuación 2, p. 514).
- El modelo incorpora TCO de servidores, nube, almacenamiento, ancho de banda y aplicaciones, además de beneficios intangibles. Varias funciones son propuestas conceptuales; una fórmula de satisfacción indica expresamente que carece de respaldo científico (nota 8, p. 517).
- No se presenta validación empírica con empresas reales; el resultado principal es el marco/modelo.

## 7. Discusión y trabajo futuro

Los autores indican que cada empresa debe personalizar factores y beneficios, y sugieren calcular NPV e IRR cuando costos y beneficios ocurren en momentos distintos. Reconocen que el modelo necesita pruebas exhaustivas con datos reales o simulados para establecer robustez y practicidad (sección **Performance analysis and scope for further work**, pp. 519–520).

## 8. Conclusión del paper

Los autores concluyen que el índice puede evitar un cálculo de ROI prematuro y orientar entre no migrar, migrar parcialmente o adoptar cloud. El modelo de ROI amplía la mirada financiera al incluir intangibles, pero su utilidad depende de personalización y validación posterior.

## Relación preliminar con INV-01

Se relaciona con 5.4–5.7, 5.12–5.14 y 6.4 de INV-01: supuestos, TCO, sensibilidad, VAN/TIR y riesgo de adopción. Es útil como antecedente conceptual, no como fórmula validada ni como fuente de precios actuales.

## Limitaciones de esta síntesis

Es una fuente de 2011, anterior a FinOps y a los modelos modernos de hyperscalers. Sus umbrales dependen de pesos definidos por los autores y el modelo no fue validado empíricamente. Varias ecuaciones e intangibles requieren evaluación crítica humana; no deben reutilizarse como conclusión del informe.

## Texto extraído del PDF

> **Advertencia de conversión:** extracción textual automática de 18 páginas (74463 caracteres). Se conservaron títulos, párrafos, referencias y contenido textual por página. La disposición multicolumna, las figuras, las tablas y las ecuaciones pueden no mantener su alineación o representación visual; verifique esos elementos en el PDF original.
...
the excess capacity would be drawn from the cloud.
     ...
     Bandwidth cost = (incoming data + outgoing data) per year × bandwidth charges.                               (4)
      Cost of using applications = j− Tn × An                                                                            (5)
                                  n=1
...
The integral T0 W(t) −110100 × average · dt takes into consideration only the positive value, i.e., the part shown in Fig. 10.
...
level. Quantification of benefits of CC calls for not the level of customer satisfaction achieved, but rather the increase of it.
   ...
   Assuming a logarithmic7 curve,
                            ...
                                 1   
      Percentage increase in profit8 = B × loge            increase                                                       (18)
                                        1 −% 100
