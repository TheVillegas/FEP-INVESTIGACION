...
> **Evidencia de clasificación:** Fila académica del CSV titulada “Cloud PricingOps: A Decision Support Framework to Explore Pricing Policies of Cloud Services”, código P2.
> **Archivo fuente:** papers-pdf/Fragiadakis et al. - 2024 - Cloud PricingOps A Decision Support Framework to Explore Pricing Policies of Cloud Services.pdf
...
- **Autores verificados en el PDF:** George Fragiadakis, Anargyros Tsadimas, Evangelia Filiopoulou, George Kousiouris, Christos Michalakelis y Mara Nikolaidou.
- **Fecha bibliográfica utilizada:** 2024. Publicado el 20 de diciembre de 2024 en *Applied Sciences*, 14, 11946.

## 3. Problema que trata

Los servicios y proveedores usan políticas de precios diferentes que evolucionan con el tiempo. Los análisis existentes aplican métodos y datasets aislados, lo que dificulta repetir, comparar o ampliar estudios de atributos de precio, costos entre alternativas y predicción. FinOps necesita un soporte de decisiones que conecte ingeniería, finanzas y negocio.

## 4. Qué quiere hacer

Proponer **CloudPricingOps**, un marco modular para integrar datasets y métodos de decisión aplicables a tres capacidades: análisis de políticas de precio, comparación de costos y predicción de precios.

## 5. Cómo lo hace

Define un proceso de selección, integración, evaluación, refinamiento y reporte de métodos, respaldado por un almacén de datos/modelos. Lo ilustra con datos reales de IaaS, PaaS y CaaS recolectados desde calculadoras oficiales en Q3–Q4 de 2023. El caso 1 usa regresión OLS para estimar la influencia de CPU, memoria, almacenamiento y ubicación; el caso 2 compara K-Means, DBSCAN y clustering jerárquico y selecciona K-Means por sus métricas de cohesión/separación (sección 5).

## 6. Resultados

- OLS se considera adecuado tras evaluar R² y MAE, y permite comparar el peso de atributos entre tipos de servicio; el paper remite a un estudio previo para las funciones detalladas (sección 5.2, figura 6).
- K-Means genera categorías interpretables —xsmall, small, medium y large— basadas en CPU/RAM y almacenamiento (sección 5.3.3).
- Como ejemplo, xsmall presenta costo medio de **USD 0,25/h** y large cerca de **USD 1,75/h** en el dataset usado (sección 5.3.4, figura 7, p. 17). Son valores del conjunto 2023, no tarifas actuales.
- Los casos muestran reutilización del mismo almacén para problemas y métodos distintos; constituyen demostraciones del marco, no una comparación exhaustiva de proveedores.

## 7. Discusión y trabajo futuro

La calidad depende del dataset; OLS puede simplificar relaciones y K-Means exige fijar el número de grupos. Los precios dinámicos requieren actualización frecuente, y quedan por probar generalización, escalabilidad y facilidad de uso. Los autores proponen análisis en tiempo real, servicios edge, modelos de ML más avanzados, recomendaciones configurables, facturación unificada y uso por brokers cloud (sección 6, pp. 18–19).

## 8. Conclusión del paper

Los autores concluyen que CloudPricingOps ofrece una estructura flexible para combinar métodos de decisión y datos en análisis, comparación y predicción de precios cloud. Los dos casos ilustran su adaptabilidad y reutilización, pero la confiabilidad está condicionada por datos, supuestos metodológicos y actualización continua.

## Relación preliminar con INV-01

Puede orientar 3.8, 4.3–4.9 y 5.11–5.13 de INV-01: compromisos costo-rendimiento, estimación, criterios de comparación y sensibilidad. No reemplaza la verificación de precios oficiales por región y fecha exigida para Santiago y EE. UU.

## Limitaciones de esta síntesis

Las cifras son ejemplos de un dataset recolectado en 2023 y no deben tratarse como precios vigentes. El paper no publica en esta pieza todos los coeficientes del primer caso. La conversión de gráficos/tablas requiere contraste visual con el PDF y validación humana.

## Texto extraído del PDF

> **Advertencia de conversión:** extracción textual automática de 20 páginas (95430 caracteres). Se conservaron títulos, párrafos, referencias y contenido textual por página. La disposición multicolumna, las figuras, las tablas y las ecuaciones pueden no mantener su alineación o representación visual; verifique esos elementos en el PDF original.
...
Revised: 8 December 2024
                            ing [1]. It is a cultural practice that is essential for organizations to ensure the efficient useAccepted: 10 December 2024
Published: 20 December 2024         of cloud resources, minimize idle resources, and align spending with business objectives. It
...
distributed under  the  terms and   and costs, quantify their business value, optimize both usage and rates paid, and manage
conditions of the Creative Commons   effective practices [1]. Capabilities refer to the functional activities that can be performed
Attribution (CC BY) license (https://   within each domain, such as forecasting, budgeting, planning, and estimating [2]. A
